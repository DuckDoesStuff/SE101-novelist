        ...
        <div className="SettingNav">
          ...
          {isProfileSelected && (
            <div className="MainContent" >
                ...
                <div className="Infocontainer"> 
                    ...
                    <input className="inputField bio" type="text" placeholder="Enter your bio.." />
          ...
          {isAccountSelected && (   
               <div className="MainContent Account" >
                ...
                <input className="inputField" type="password" placeholder="Enter your current password" />
                <p className="text small">New Password</p>
                <input className="inputField" type="password" placeholder="Enter your new password" />
                ...
                <hr className="hrline"/>
                <p className="text small">Once you delete your account, there is no going back. Please be certain!</p>
